<template>
  <nav style="display: flex" class="navigation">
    <svg class="bar" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" @click="closeMenu">
      <!-- Font Awesome Pro 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) -->
      <path
        d="M16 132h416c8.837 0 16-7.163 16-16V76c0-8.837-7.163-16-16-16H16C7.163 60 0 67.163 0 76v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16z" />
    </svg>
    <div v-if="width < 1121 && isOpenMenu" class="mobile-container" ref="mobile">
      <div class="topnav">
        <div id="myLinks">
          <ul>
          ...
          <ul class="mobile__item-bottom">
            <li class="mobile__subitem-bottom">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" xml:space="preserve" width="30px"
                fill="gray">
                <path fill="#282828"
              ...
              <a href="mailto:info@talkearn.app" style="color: gray">info@instaservice.io</a>
            </li>
            <li class="mobile__subitem-bottom">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" style="enable-background: new 0 0 120 120"
                xml:space="preserve" width="20" fill="gray">
                <switch>
                  <g>
                    <path
      ...
      <li class="navigation__item">
        <v-menu open-on-hover rounded="b-xl" offset-y>
          <template #activator="{ on, attrs }">
            <div style="z-index: 10" v-bind="attrs" v-on="on"><nuxt-link to="/">Home</nuxt-link></div>
          </template>
        </v-menu>
      </li>
      <li class="navigation__item">
